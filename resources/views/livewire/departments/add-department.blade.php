            ...
            <div class="relative bg-white rounded-lg shadow" x-on:click.away="isModalOpen = false">
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <div class="mb-5">
                        ...
                        <input type="text" wire:model="name" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Department name" required />
                        @error('name')
