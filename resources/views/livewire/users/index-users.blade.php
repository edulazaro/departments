<div class="grid mb-2 gap-4 xl:grid-cols-1 pb-0 w-100">
    ...
    <input wire:model.live.debounce.500ms="searchText" type="text" class="mt-4 w-100 p-2.5 bg-gray-50 border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-50 rounded border" placeholder="Search for a user">
            ...
            <tbody>
                ...
                <tr wire:key="user_{{ $user->id }}" class="bg-white border-b hover:bg-gray-50">
                    ...
                    <td class="px-2 py-2 text-right" x-data="{ open: false }" x-on:click.outside="open = false">
                        <button id="dropdown_toggle_{{ $user->id }}" x-on:click="open = !open" class="focus:rotate-90 transition-transform mr-2 text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm text-center inline-flex items-center" type="button">
                        ...
                        <div id="dropdown_{{$user->id}}" x-on:click="open = false" x-cloak x-show="open" x-transition.opacity class="z-10 mr-2 mt-1 right-2 absolute bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
                            <ul class="py-Z text-sm text-gray-700" aria-labelledby="dropdownDefaultButton">
                                <li>
                                    <a href="#/" wire:click="$dispatch('editUserDepartments', { 'user' : {{ $user }} })" class="block px-4 py-2 hover:bg-gray-100">
                                        ...
                                        <span class="inline-block ml-1">Departments</span>
                                    </a>
                                </li>
                                <hr>
                                <li>
                                    <a href="#/" wire:click="$dispatch('editUser', { 'user' : {{ $user }} })" class="block px-4 py-2 hover:bg-gray-100">
                                        <svg class="w-5 h-5 inline-block" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                ...
                                <li>
                                    <a href="#/" wire:click="deleteUser({{ $user }})" class="block px-4 py-2 hover:bg-gray-100">
                                        <svg class="w-5 h-5 inline-block" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
    ...
    <livewire:users.edit-user-departments />
</div>